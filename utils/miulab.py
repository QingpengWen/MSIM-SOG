...
def __startOfChunk(prevTag, tag, prevTagType, tagType, chunkStart=False):
	...
	if prevTag == 'S' and tag == 'S':
		chunkStart = True
	if prevTag == 'S' and tag == 'B':
		chunkStart = True
	if prevTag == 'S' and tag == 'I':
		chunkStart = True
	if prevTag == 'S' and tag == 'E':
		chunkStart = True
	if prevTag == 'B' and tag == 'S':
		chunkStart = True
	if prevTag == 'I' and tag == 'S':
		chunkStart = True
	if prevTag == 'E' and tag == 'S':
		chunkStart = True

	if prevTag == 'E' and tag == 'B':
		chunkStart = True
	if prevTag == 'O' and tag == 'S':
		chunkStart = True
